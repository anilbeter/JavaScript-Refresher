...
//     // Converting JSON to actual JavaScript object
...
// const arrAnil = [23, 'anil', 'Ocean'];
// const [firstMay] = arrAnil;
// console.log(firstMay);
// 23
...
//       if (!neighbour) throw new Error('No neighbourd found!');
...
// Reverse Geocoding function from Challenge #1
const whereAmI = function () {
  getPosition()
    .then(pos => {
      const { latitude: lat, longtiude: lng } = pos.coords;
      return fetch(
        `https://api.bigdatacloud.net/data/reverse-geocode-client?latitude=${lat}&longitude=${lng}`
      );
    })
