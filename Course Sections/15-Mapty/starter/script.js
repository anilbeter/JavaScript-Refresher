...
class Workout {
  date = new Date();
  id = (Date.now() + '').slice(-5); // şu anki anlık zamanın mili sn cinsinden son 5 rakamını alıyorum id olarak, unique olması icin
...
class App {
  ...
  _newWorkout(e) {
    ...
    // bütün inp'lar isFinite mı diye kontrol eden minik bir fonksiyon
    // içlerinden sadece biri bile bu şartı sağlamazsa, false vericek
    ...
    if (type === 'running') {
      ...
      // Check if data is valid (w/ guard clause)
      if (
